        ...
        try:
            ...
            for result in cursor.stored_results():
                ...
                for cart_row in result.fetchall():
                    ...
                    cart.discount = cart_row[3]                    
                    cart.book.ISBN13 = cart_row[4]
                    cart.book.ISBN10 = cart_row[5]
                    cart.book.title = cart_row[6]
                    cart.book.copyRightDate = cart_row[7]
                    cart.book.bookType = cart_row[8]
                    cart.book.edition = cart_row[9]
                    cart.book.numberOfPages = cart_row[10]
                    cart.book.genre.genre_id = cart_row[11]
                    cart.book.author.author_id = cart_row[12]
                    cart.book.publisher.publisher_id = cart_row[13]
                    cart.book.inventory.quantity_on_hand = cart_row[14]
                    cart.book.inventory.retail_price = cart_row[15]
                    cart.total_item_price = cart_row[16]
