    ...
    def post(self, request, book_id):
        ...
        if 'update-book' in request.POST:
            if book_form.is_valid():
                ...
                updated_inventory.quantity_on_hand = book_form.cleaned_data['quantity_on_hand']
                updated_inventory.quantity_ordered = x.quantity_ordered
                updated_inventory.retail_price = book_form.cleaned_data['retail_price']
...
class AdminAddBookView(TemplateView):
    template_name = 'Store/admin/books/addbook.html'
    book_dao = BookDao()
    publisher_dao = PublisherDao()
    genre_dao = GenreDao()
    author_dao = AuthorDao()
